...
final class ParallelCipherCore {
     ...
     * the cipher mode
     */
    private final int cipherMode = ECB_MODE;
     ...
     * PKCS5Padding.
     */
    ParallelCipherCore(ParallelSymmetricCipher impl, int blkSize) {
        blockSize = blkSize;
        unitBytes = blkSize;
        ...
        cipher = new ParallelElectronicCodeBook(impl);
