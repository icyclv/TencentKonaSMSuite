...
public final class VectorizedSM3MessageDigest extends MessageDigest implements Cloneable {

    private VectorizedSM3Engine engine = new VectorizedSM3Engine();

    public VectorizedSM3MessageDigest() {
        super("VectorizedSM3");
    }
    ...
    public Object clone() throws CloneNotSupportedException {
        VectorizedSM3MessageDigest clone = (VectorizedSM3MessageDigest) super.clone();
