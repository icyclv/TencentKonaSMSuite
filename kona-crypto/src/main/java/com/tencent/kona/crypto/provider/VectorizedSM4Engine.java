 ...
 */
public final class VectorizedSM4Engine {

    // SIMD vector size
    public final static VectorSpecies<Byte> SM4_BYTE_SPECIES;
    public final static VectorSpecies<Integer> SM4_INT_SPECIES;
    // The size of process multiple blocks in one iteration(bytes)
    public final static int WALK_SIZE;
    ...
    private final static int[] indexMap;

    static {
        SM4_BYTE_SPECIES = ByteVector.SPECIES_PREFERRED;
        SM4_INT_SPECIES = IntVector.SPECIES_PREFERRED;
        WALK_SIZE = SM4_INT_SPECIES.length() * 16;
        indexMap = new int[SM4_BYTE_SPECIES.length()];
        for (int i = 0; i < SM4_BYTE_SPECIES.length() / 4; i++) {
            indexMap[i * 4] = i * 16 + 3;
            indexMap[i * 4 + 1] = i * 16 + 2;
            indexMap[i * 4 + 2] = i * 16 + 1;
            indexMap[i * 4 + 3] = i * 16;
        }
    }

    public VectorizedSM4Engine(byte[] key, boolean encrypt) {
    ...
    public void parallelProcessBlocks(
            byte[] in, int inOffset,
            byte[] out, int outOffset) {
        IntVector r0, r1, r2, r3, r4;

        // Big-endian
        r0 = ByteVector.fromArray(SM4_BYTE_SPECIES, in, inOffset, indexMap, 0).reinterpretAsInts();
        r1 = ByteVector.fromArray(SM4_BYTE_SPECIES, in, inOffset + 4, indexMap, 0).reinterpretAsInts();
        r2 = ByteVector.fromArray(SM4_BYTE_SPECIES, in, inOffset + 8, indexMap, 0).reinterpretAsInts();
        r3 = ByteVector.fromArray(SM4_BYTE_SPECIES, in, inOffset + 12, indexMap, 0).reinterpretAsInts();


        for (int i = 0; i < 8; i++) {
            r4 = IntVector.broadcast(SM4_INT_SPECIES, rk[i * 4]);
            r4 = r4.lanewise(VectorOperators.XOR, r1);
            r4 = r4.lanewise(VectorOperators.XOR, r2);
            r4 = r4.lanewise(VectorOperators.XOR, r3);
            r0 = r0.lanewise(VectorOperators.XOR, IntVector.fromArray(SM4_INT_SPECIES, T3, 0, r4.lanewise(VectorOperators.AND, 255).toArray(), 0));
            r0 = r0.lanewise(VectorOperators.XOR, IntVector.fromArray(SM4_INT_SPECIES, T2, 0, r4.lanewise(VectorOperators.ROR, 8).lanewise(VectorOperators.AND, 255).toArray(), 0));
            r0 = r0.lanewise(VectorOperators.XOR, IntVector.fromArray(SM4_INT_SPECIES, T1, 0, r4.lanewise(VectorOperators.ROR, 16).lanewise(VectorOperators.AND, 255).toArray(), 0));
            r0 = r0.lanewise(VectorOperators.XOR, IntVector.fromArray(SM4_INT_SPECIES, T0, 0, r4.lanewise(VectorOperators.ROR, 24).lanewise(VectorOperators.AND, 255).toArray(), 0));

            r4 = IntVector.broadcast(SM4_INT_SPECIES, rk[i * 4 + 1]);
            r4 = r4.lanewise(VectorOperators.XOR, r0);
            r4 = r4.lanewise(VectorOperators.XOR, r2);
            r4 = r4.lanewise(VectorOperators.XOR, r3);
            r1 = r1.lanewise(VectorOperators.XOR, IntVector.fromArray(SM4_INT_SPECIES, T3, 0, r4.lanewise(VectorOperators.AND, 255).toArray(), 0));
            r1 = r1.lanewise(VectorOperators.XOR, IntVector.fromArray(SM4_INT_SPECIES, T2, 0, r4.lanewise(VectorOperators.ROR, 8).lanewise(VectorOperators.AND, 255).toArray(), 0));
            r1 = r1.lanewise(VectorOperators.XOR, IntVector.fromArray(SM4_INT_SPECIES, T1, 0, r4.lanewise(VectorOperators.ROR, 16).lanewise(VectorOperators.AND, 255).toArray(), 0));
            r1 = r1.lanewise(VectorOperators.XOR, IntVector.fromArray(SM4_INT_SPECIES, T0, 0, r4.lanewise(VectorOperators.ROR, 24).lanewise(VectorOperators.AND, 255).toArray(), 0));

            r4 = IntVector.broadcast(SM4_INT_SPECIES, rk[i * 4 + 2]);
            r4 = r4.lanewise(VectorOperators.XOR, r0);
            r4 = r4.lanewise(VectorOperators.XOR, r1);
            r4 = r4.lanewise(VectorOperators.XOR, r3);
            r2 = r2.lanewise(VectorOperators.XOR, IntVector.fromArray(SM4_INT_SPECIES, T3, 0, r4.lanewise(VectorOperators.AND, 255).toArray(), 0));
            r2 = r2.lanewise(VectorOperators.XOR, IntVector.fromArray(SM4_INT_SPECIES, T2, 0, r4.lanewise(VectorOperators.ROR, 8).lanewise(VectorOperators.AND, 255).toArray(), 0));
            r2 = r2.lanewise(VectorOperators.XOR, IntVector.fromArray(SM4_INT_SPECIES, T1, 0, r4.lanewise(VectorOperators.ROR, 16).lanewise(VectorOperators.AND, 255).toArray(), 0));
            r2 = r2.lanewise(VectorOperators.XOR, IntVector.fromArray(SM4_INT_SPECIES, T0, 0, r4.lanewise(VectorOperators.ROR, 24).lanewise(VectorOperators.AND, 255).toArray(), 0));

            r4 = IntVector.broadcast(SM4_INT_SPECIES, rk[i * 4 + 3]);
            r4 = r4.lanewise(VectorOperators.XOR, r0);
            r4 = r4.lanewise(VectorOperators.XOR, r1);
            r4 = r4.lanewise(VectorOperators.XOR, r2);
            r3 = r3.lanewise(VectorOperators.XOR, IntVector.fromArray(SM4_INT_SPECIES, T3, 0, r4.lanewise(VectorOperators.AND, 255).toArray(), 0));
            r3 = r3.lanewise(VectorOperators.XOR, IntVector.fromArray(SM4_INT_SPECIES, T2, 0, r4.lanewise(VectorOperators.ROR, 8).lanewise(VectorOperators.AND, 255).toArray(), 0));
            r3 = r3.lanewise(VectorOperators.XOR, IntVector.fromArray(SM4_INT_SPECIES, T1, 0, r4.lanewise(VectorOperators.ROR, 16).lanewise(VectorOperators.AND, 255).toArray(), 0));
            r3 = r3.lanewise(VectorOperators.XOR, IntVector.fromArray(SM4_INT_SPECIES, T0, 0, r4.lanewise(VectorOperators.ROR, 24).lanewise(VectorOperators.AND, 255).toArray(), 0));
        }

        r3.reinterpretAsBytes().intoArray(out, outOffset, indexMap, 0);
        r2.reinterpretAsBytes().intoArray(out, outOffset + 4, indexMap, 0);
        r1.reinterpretAsBytes().intoArray(out, outOffset + 8, indexMap, 0);
        r0.reinterpretAsBytes().intoArray(out, outOffset + 12, indexMap, 0);
