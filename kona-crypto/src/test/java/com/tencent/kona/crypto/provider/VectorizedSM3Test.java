...
public class VectorizedSM3Test {
    ...
    public void testKAT() throws Exception {
        checkDigest("VectorizedSM3", MESSAGE_SHORT, DIGEST_SHORT);
        checkDigest("VectorizedSM3", MESSAGE_LONG, DIGEST_LONG);
    }
    ...
    public void testGetDigestLength() throws Exception {
        MessageDigest md = MessageDigest.getInstance("VectorizedSM3", PROVIDER);
    ...
    public void testEmptyInput() throws Exception {
        MessageDigest md1 = MessageDigest.getInstance("VectorizedSM3", PROVIDER);
        md1.update(new byte[0]);
        byte[] digest1 = md1.digest();

        MessageDigest md2 = MessageDigest.getInstance("VectorizedSM3", PROVIDER);
    ...
    public void testBigByteBuffer() throws Exception {
        ...
        MessageDigest mdBuffer = MessageDigest.getInstance("VectorizedSM3", PROVIDER);
